...
export default function ReviewFormDelivery({
  name,
  idUser,
  idOrder,
}: {
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex-col items-center justify-center">
                ...
                <label key={value}>
                  <input
                    ...
                    className={`mask mask-star ${
                      value <= rating ? "bg-yellow-400" : "bg-black"
                    }`}
          ...
          <div className="flex items-center justify-end pt-10 space-x-4">
            <Link
              href="/user/client/historial"
              className="btn btn-active bg-red-500"
            >
              Cancelar
            </Link>
            <button className="btn btn-active bg-green-400" type="submit">
              Enviar
            </button>
          </div>
        </div>
